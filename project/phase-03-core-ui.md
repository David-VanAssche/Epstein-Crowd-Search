...
#### Data Sources Page — `app/(public)/sources/page.tsx`

Shows ingestion status for all 24 community and official data sources. Critical for transparency and tracking which sources are live.
